...
int main() {
    ...
    double L = 0.6;           // Example value for L
    ...
    double V2 = 0.315;        // Initial guess for V2 - 0.53

    double V2_result = 0;
    int max_iterations = 3;  // Maximum number of iterations
    int iteration = 0;
    ...
    //     if(!isnan(V2_result)) V2 = (V2_result + V2) / 2;
    //     else V2 += 1; 
    //     iteration++;
    // }
